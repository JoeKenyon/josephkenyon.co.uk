...
thumbnail: "Pasted image 20260219173509.png"
---
...
{% image "./Pasted image 20260219173509.png", "Max/MSP reverse engineering logic" %}
...
{% image "./Pasted image 20260219173207.png", "C++ Implementation architecture in JUCE" %}
...
{% image "./Pasted image 20260219173232.png", "Custom engine vibration signal modulation" %}

{% image "./Pasted image 20260219173251.png", "Waveform analysis of engine models" %}

{% image "./Pasted image 20260219173302.png", "Spectral comparison chart" %}
