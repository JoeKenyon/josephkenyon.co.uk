...
thumbnail: "./assets/engine-audio-max-logic.png"
---
...
![Max/MSP reverse engineering logic](./assets/engine-audio-max-logic.png)
...
![C++ Implementation architecture in JUCE](./assets/engine-audio-juce-arch.png)
...
![Custom engine Web Audio UI](./assets/engine-audio-web-ui.png)

![Spectral analysis of engine models](./assets/engine-audio-spectral.png)

![Waveform comparison of engine models](./assets/engine-audio-waveform.png)
