...
I explored **digital signal processing** techniques to apply a variety of effects to an electric guitar's audio signal in real-time. The hardware, a **STM32F7-46NG** board with a **WM8994 audio codec**, provides a robust foundation for this work.
...
{% image "./param_gtr.png", "Parameter Control Interface" %}

{% image "./menu_gtr.png", "Main Effects Menu" %}
...
Firmware was developed in **C** for real-time efficiency. **DMA** automates audio data transfer, ensuring a continuous stream. The UI prioritises a simple, functional design with low processing overhead. **I2C** is the communication protocol used to talk to the WM8994 audio codec. 
